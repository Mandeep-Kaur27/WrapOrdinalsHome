    ...
    <div className="home">      
      ...
      <section className="popular-artist-wrapper">
        <div className="popular-artist">
          <div className="artist-wrap artist-9">
          ...
          <div className="artist-wrap artist-8">
          ...
          <div className="artist-wrap artist-7">
          ...
          <div className="artist-wrap artist-6">
          ...
          <div className="artist-wrap artist-5">
          ...
          <div className="artist-wrap artist-4">
          ...
          <div className="artist-wrap artist-3">
          ...
          <div className="artist-wrap artist-2">
          ...
          <div className="artist-wrap artist-1">
